...
- Name: pii-redaction.spec.ts >> PII Detection and Redaction Verification >> should verify PII element selectors are valid
- Location: tests\e2e\pii-redaction.spec.ts:56:3
...
Locator: locator('#aadhaar')
Expected: attached
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeAttached" locator('#aadhaar') with timeout 5000ms
  - waiting for locator('#aadhaar')
