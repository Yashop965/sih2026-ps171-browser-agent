...
- Name: session-management.spec.ts >> Session Management Across Tabs >> should update session timestamp on interaction
- Location: tests\e2e\session-management.spec.ts:101:3
