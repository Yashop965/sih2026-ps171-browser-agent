...
- Name: session-management.spec.ts >> Session Management Across Tabs >> should track session across multiple tabs
- Location: tests\e2e\session-management.spec.ts:9:3
