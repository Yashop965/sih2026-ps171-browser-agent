...
- Name: session-management.spec.ts >> Session Management Across Tabs >> should create new session on page reload
- Location: tests\e2e\session-management.spec.ts:37:3
...
Locator: locator('h1')
Expected substring: "E2E Test Page"
Timeout: 5000ms
