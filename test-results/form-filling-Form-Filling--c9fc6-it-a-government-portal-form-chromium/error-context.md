...
- Name: form-filling.spec.ts >> Form Filling Scenario >> should fill and submit a government portal form
- Location: tests\e2e\form-filling.spec.ts:16:3
...
Locator: locator('h1')
Expected substring: "Government Service Portal"
...
Call log:
  ...
  - waiting for locator('h1')
    14 × locator resolved to <h1>Error response</h1>
