...
const TASK =
  "Read-only task. Using the Wikipedia search box, look up 'World Wide Web' and open that article. " +
  "Then, from that article, use the search box to look up 'Tim Berners-Lee' and open it. " +
  "Then, from that article, use the search box to look up 'Hypertext' and open it. " +
  "The task is COMPLETE only when the 'Hypertext' article is on screen. " +
