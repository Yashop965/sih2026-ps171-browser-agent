...
export default function ResourceMonitor() {
  const { jsHeapUsedMB, jsHeapTotalMB, jsHeapPercent, cpuCores, gpuAdapter, status } =
    useSystemResources();
  ...
  return (
    <div
      ...
      title={`Memory: ${jsHeapUsedMB}MB / ${jsHeapTotalMB}MB | CPU: ${cpuCores} cores | Status: ${status}`}
    >
      {/* Header */}
